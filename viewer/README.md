...
Десктопное приложение для нативного отображения покерных скриншотов.
Создаёт **borderless окно точно по размеру картинки** в указанной позиции экрана,
чтобы HDMI capture получал 1:1 копию исходного изображения без UI-обвязки
браузера. Используется для тестирования покерного бота.
...
разрешении** (например, 1918×1078 для скриншотов 1080p).
